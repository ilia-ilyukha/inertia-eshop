...
const appName = "Inertia eshop";
createServer(
  (page) => createInertiaApp({
    page,
    render: renderToString,
    title: (title) => `${title} - ${appName}`,
    resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-BjwOEphs.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-BKU_FbwP.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-hHDCsviG.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-oilrlLtt.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-CXYecdqA.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-kBCqkwk9.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-IUHUrdG0.js"), "./Pages/Event/Show.vue": () => import("./assets/Show-Ds5OYXxl.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-ClOtpnEY.js"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-DFRCl3Sh.js"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-CYYEVMV-.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-BwLAAesb.js"), "./Pages/Shop/Index.vue": () => import("./assets/Index-DECqwWDg.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-D9_afehU.js") })),
